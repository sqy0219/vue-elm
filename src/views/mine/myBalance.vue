<template>
  <div class="myBalance">
    <NavTop4 title="我的余额" icon6 />
    <div class="bgr">
      <div class="myBala">
        <div class="nowBala">
          <span class="money">当前余额</span>
          <span class="say">
            <router-link to="/profile/myBalance/state">
              <i class="fa fa-question-circle fa-lg"></i> &nbsp;余额说明
            </router-link>
          </span>
        </div>
        <div class="mBala">
